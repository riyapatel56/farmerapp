...
class TacDetailPage extends StatefulWidget {

  static const routeName = '/tac-detail';

  @override
  _TacDetailPageState createState() => _TacDetailPageState();
}

class _TacDetailPageState extends State<TacDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final tacId = ModalRoute.of(context).settings.arguments as String;
    final loadedTac = Provider.of<Trallcrops>(context).findbyId(tacId);
    //final cart = Provider.of<Cart>(context);
    
    return Scaffold(
      backgroundColor: Colors.green[100],
      appBar: AppBar(
        title: Text(loadedTac.name,style: GoogleFonts.openSans(),),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                    child: Image.asset(loadedTac.imgUrl,fit: BoxFit.fitWidth,),
                  ),
                )
              ),
            ),
            ...
            Padding(
              ...
              child: Text(loadedTac.bdescription,
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Types of ${loadedTac.name}',style: GoogleFonts.openSans(fontSize: 16,color: Colors.purple[600],fontWeight: FontWeight.w500),
                        ),
                      ),
