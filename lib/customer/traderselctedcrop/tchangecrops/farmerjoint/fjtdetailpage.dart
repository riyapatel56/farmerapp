...
class TjcDetailPage extends StatelessWidget {
  
  static const routeName = '/traderjc-detail';


  @override
  Widget build(BuildContext context) {

    final traderjcId = ModalRoute.of(context).settings.arguments as String;
    final loadedTraderjc = Provider.of<Traderjcs>(context).findbyId(traderjcId);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.cyan[900],
        elevation: 0,
        title: Text(loadedTraderjc.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedTraderjc.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedTraderjc.imgUrl),
                            ),
                          ),
                        ),
                      ),
