...
class TTrdDetailPage extends StatefulWidget {

  static const routeName = '/ttraditional-detail';

  @override
  _TTrdDetailPageState createState() => _TTrdDetailPageState();
}

class _TTrdDetailPageState extends State<TTrdDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final ttraditionalId = ModalRoute.of(context).settings.arguments as String;
    final loadedTtrd = Provider.of<Ttraditionals>(context).findbyId(ttraditionalId);
    //final cart = Provider.of<Cart>(context);
    
    return Scaffold(
      backgroundColor: Colors.green[100],
      appBar: AppBar(
        title: Text(loadedTtrd.name,style: GoogleFonts.openSans(),),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                    child: Image.asset(loadedTtrd.imgUrl,fit: BoxFit.fitWidth,),
                  ),
                )
              ),
            ),
            ...
            Padding(
              ...
              child: Text(loadedTtrd.bdescription,
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Types of ${loadedTtrd.name}',style: GoogleFonts.openSans(fontSize: 16,color: Colors.purple[600],fontWeight: FontWeight.w500),
                        ),
                      ),
