...
class Torganic with ChangeNotifier{
  final String id;
...
class Torganics with ChangeNotifier{
  List<Torganic> _items =[
    Torganic(
      id: '1', 
      category: 'Torganic', 
      name: 'Coffee', 
  ...
  List<Torganic>get items {
    return[..._items];
  }

  Torganic findbyId(String id){
    return _items.firstWhere((org) => org.id == id);
  }
}