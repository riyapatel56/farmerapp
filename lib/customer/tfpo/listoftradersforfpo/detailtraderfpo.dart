...
class TJFPODetailPage extends StatelessWidget {
  
  static const routeName = '/traderfpo-detail';


  @override
  Widget build(BuildContext context) {

    final tfpoPlace = ModalRoute.of(context).settings.arguments as String;
    final loadedtfpo = Provider.of<Traderfpos>(context).findbyPlace(tfpoPlace);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        elevation: 0,
        title: Text(loadedtfpo.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedtfpo.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedtfpo.imgUrl),
                            ),
                          ),
                        ),
                      ),
