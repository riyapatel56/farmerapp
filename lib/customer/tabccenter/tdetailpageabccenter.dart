...
import 'listoftraders/tcenterlist.dart';


class TCntDetailPage extends StatefulWidget {

  static const routeName = '/tcenter-detail';

  @override
  _TCntDetailPageState createState() => _TCntDetailPageState();
}
...
//flatbutton
  ...
  Widget build(BuildContext context) {
    ...
    final loadedCenter = Provider.of<Tcenters>(context).findbyId(centerId);
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: () {  
                                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => TraderJCenter()));
                                  },
                                  child: Text(
                                    'View',
