import 'package:farmer/customer/msp/organicmsp/torgcropmsp.dart';
...
class TOrgMCropsHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    
    final mspallcropData = Provider.of<Torgmspcrops>(context);
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Text(
                    ...
                    style: GoogleFonts.roboto(fontSize: 0.025 * MediaQuery.of(context).size.height,color: Colors.black),
                  ),
