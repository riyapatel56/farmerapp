...
import 'package:farmer/customer/msp/trdmsp/ttrdcropmsp.dart';
...
class TTrdMCropsHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    
    final mspallcropData = Provider.of<Ttrdmspcrops>(context);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GridView.builder(
          ...
          child: TrdMItem(name: macps[i].name,imageUrl: macps[i].imgUrl,msp: macps[i].msp,),
          ),
        ),
      ),
    );
...
class TrdMItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        //Navigator.of(context).push(MaterialPageRoute(builder: (context) => TTrdMCropsHome()));
      },
      child: Padding(
