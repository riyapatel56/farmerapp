...
class TraderSelectedFarmerList extends StatefulWidget {
  @override
  _TraderSelectedFarmerListState createState() => _TraderSelectedFarmerListState();
}

class _TraderSelectedFarmerListState extends State<TraderSelectedFarmerList> {
  @override
