...
class FmfpoDetailPage extends StatelessWidget {
  
  static const routeName = '/fmfpo-detail';


  @override
  Widget build(BuildContext context) {

    final fmfpoPlace = ModalRoute.of(context).settings.arguments as String;
    final loadedFmfpo = Provider.of<Fmfpos>(context).findbyPlace(fmfpoPlace);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.purple[900],
        elevation: 0,
        title: Text(loadedFmfpo.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedFmfpo.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedFmfpo.imgUrl),
                            ),
                          ),
                        ),
                      ),
