...
class TSellCrop extends StatefulWidget {
  @override
  _TSellCropState createState() => _TSellCropState();
}

class _TSellCropState extends State<TSellCrop> {
  TextEditingController land = TextEditingController();
  TextEditingController money = TextEditingController();
  TextEditingController cropbuy = TextEditingController();
  TextEditingController minvested = TextEditingController();
  TextEditingController cquantity = TextEditingController();
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Column(
                              ...
                              children: <Widget>[
                                new Text('Which Crop You Want To Buy',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      fontSize: 16.0,
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Column(
                              ...
                              children: <Widget>[
                                new Text(
                                  'How Much Quantity Of Crop You Want?',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w600,
                          ...
                          children: <Widget>[
                            new Flexible(
                              child: new TextField(
                                controller: land,
                                decoration: const InputDecoration(
                                  hintText: "Enter Your Crop Quantity",
                                ),
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Column(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children: <Widget>[
                                new Text('Want To Transport Crop By Us?',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w600,
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Column(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children: <Widget>[
                                new Text('Estimated Date By Which You Want Crop',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w600,
                    ...
                    Padding(
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Flexible(
                              child: new TextField(
                                controller: minvested,
                                decoration: const InputDecoration(
                                  hintText: "Enter Date in 2-02-21 this format",
                                ),
                                enabled: true,
                                // autofocus: !_status,
                              ),
