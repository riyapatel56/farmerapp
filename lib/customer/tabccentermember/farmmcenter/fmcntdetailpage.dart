...
class FmcntDetailPage extends StatelessWidget {
  
  static const routeName = '/fmcentr-detail';


  @override
  Widget build(BuildContext context) {

    final fmcentrPlace = ModalRoute.of(context).settings.arguments as String;
    final loadedFmcentr = Provider.of<Fmcenters>(context).findbyPlace(fmcentrPlace);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.purple[900],
        elevation: 0,
        title: Text(loadedFmcentr.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedFmcentr.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedFmcentr.imgUrl),
                            ),
                          ),
                        ),
                      ),
