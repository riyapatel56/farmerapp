...
class ScbDetailPage extends StatelessWidget {
  
  static const routeName = '/scbuyer-detail';


  @override
  Widget build(BuildContext context) {

    final scbuyerId = ModalRoute.of(context).settings.arguments as String;
    final loadedScbuyer = Provider.of<Scbuyers>(context).findbyId(scbuyerId);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.green[900],
        elevation: 0,
        title: Text(loadedScbuyer.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedScbuyer.imgUrl),
                            ),
                          ),
                        ),
                      ),
