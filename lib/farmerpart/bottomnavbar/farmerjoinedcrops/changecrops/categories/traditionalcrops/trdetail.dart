...
class TrdDetailPage extends StatefulWidget {

  static const routeName = '/traditional-detail';

  @override
  _TrdDetailPageState createState() => _TrdDetailPageState();
}

class _TrdDetailPageState extends State<TrdDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final traditionalId = ModalRoute.of(context).settings.arguments as String;
    final loadedTrd = Provider.of<Traditionals>(context).findbyId(traditionalId);
    //final cart = Provider.of<Cart>(context);
    
    return Scaffold(
      backgroundColor: Colors.green[100],
      appBar: AppBar(
        title: Text(loadedTrd.name,style: GoogleFonts.roboto(),),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                    child: Image.asset(loadedTrd.imgUrl,fit: BoxFit.fitWidth,),
                  ),
                )
              ),
            ),
            ...
            Padding(
              ...
              child: Text(loadedTrd.bdescription,
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Types of ${loadedTrd.name}',style: GoogleFonts.openSans(fontSize: 16,color: Colors.purple[600],fontWeight: FontWeight.w500),
                        ),
                      ),
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Total Farmers Joined = ${loadedTrd.farmerno}',
