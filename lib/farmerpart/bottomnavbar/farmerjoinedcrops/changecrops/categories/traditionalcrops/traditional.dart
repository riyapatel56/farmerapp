...
class Traditional with ChangeNotifier{
  final String id;
...
class Traditionals with ChangeNotifier{
  List<Traditional> _items =[
    Traditional(
      id: '1', 
      category: 'Organic', 
      name: 'Coffee', 
  ...
  List<Traditional>get items {
    return[..._items];
  }

  Traditional findbyId(String id){
    return _items.firstWhere((trd) => trd.id == id);
  }
}