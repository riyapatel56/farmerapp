import 'package:farmer/farmerpart/bottomnavbar/farmerjoinedcrops/changecrops/categories/organiccrops/organic.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

import 'ocdetail.dart';
...
class OrgItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final org = Provider.of<Organic>(context);
    //final cart = Provider.of<Cart>(context);

    return GestureDetector(
      onTap: () {
        Navigator.of(context).pushNamed(OrganicDetailPage.routeName,arguments: org.id);
      },
      child: FittedBox(
      fit: BoxFit.contain,
      child: ClipRRect(
