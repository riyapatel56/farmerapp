...
import 'farmerjoin.dart';


class FjcDetailPage extends StatelessWidget {
  
  static const routeName = '/farmerjc-detail';


  @override
  Widget build(BuildContext context) {

    final farmerjcId = ModalRoute.of(context).settings.arguments as String;
    final loadedFarmerjc = Provider.of<Farmerjcs>(context).findbyId(farmerjcId);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.green[900],
        elevation: 0,
        title: Text(loadedFarmerjc.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedFarmerjc.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedFarmerjc.imgUrl),
                            ),
                          ),
                        ),
                      ),
