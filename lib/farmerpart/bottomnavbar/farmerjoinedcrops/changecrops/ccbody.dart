...
class ChangeCropBody extends StatelessWidget {
  @override
              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => OrganicCropMain()));
                    },
                    child: Padding(
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => TraditionalCropMain()));
                    },
                    child: Padding(
