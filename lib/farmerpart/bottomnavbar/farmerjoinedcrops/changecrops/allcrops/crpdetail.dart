...
class CrpDetailPage extends StatefulWidget {

  static const routeName = '/crop-detail';

  @override
  _CrpDetailPageState createState() => _CrpDetailPageState();
}

class _CrpDetailPageState extends State<CrpDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedCrp = Provider.of<Allcrops>(context).findbyId(cropId);
    //final cart = Provider.of<Cart>(context);
    
    return Scaffold(
      backgroundColor: Colors.green[100],
      appBar: AppBar(
        title: Text(loadedCrp.name,style: GoogleFonts.roboto(),),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                    child: Image.asset(loadedCrp.imgUrl,fit: BoxFit.fitWidth,),
                  ),
                )
              ),
            ),
            ...
            Padding(
              ...
              child: Text(loadedCrp.bdescription,
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Types of ${loadedCrp.name}',style: GoogleFonts.openSans(fontSize: 16,color: Colors.purple[600],fontWeight: FontWeight.w500),
                        ),
                      ),
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Total Farmers Joined = ${loadedCrp.farmerno}',
