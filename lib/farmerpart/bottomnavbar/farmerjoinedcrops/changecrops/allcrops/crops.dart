...
class Allcrop with ChangeNotifier{
  final String id;
...
class Allcrops with ChangeNotifier{
  List<Allcrop> _items =[
    Allcrop(
      id: '1', 
      category: 'Organic', 
  ...
  List<Allcrop>get items {
    return[..._items];
  }

  Allcrop findbyId(String id){
    return _items.firstWhere((crp) => crp.id == id);
  }
}