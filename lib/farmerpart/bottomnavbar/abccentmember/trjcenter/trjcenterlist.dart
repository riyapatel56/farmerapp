import 'package:farmer/farmerpart/bottomnavbar/abccentmember/trjcenter/trjcdetailpage.dart';
...
class TrjcItem extends StatelessWidget {
  ...
  const TrjcItem({Key key,this.phoneno, this.landAcre, this.id, this.name, this.growing, this.since, this.place, this.rating, this.imgUrl, this.email}) : super(key: key);
