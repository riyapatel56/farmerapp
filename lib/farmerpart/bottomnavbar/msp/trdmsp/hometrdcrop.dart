import 'package:farmer/farmerpart/bottomnavbar/msp/trdmsp/trdcropmsp.dart';
...
class TrdMCropsHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    
    final mspallcropData = Provider.of<Trdmspcrops>(context);
