...
import 'allcropmsp.dart';

class MSPAllCropsHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    
    final mspallcropData = Provider.of<Mspallcrops>(context);
    ...
    return GridView.builder(
      ...
      child: MSPACItem(name: macps[i].name,imageUrl: macps[i].imgUrl,msp: macps[i].msp,),
      ),
    );
  }
}

class MSPACItem extends StatelessWidget {
