...
class TrjcDetailPage extends StatelessWidget {
  
  static const routeName = '/trjcentr-detail';


  @override
  Widget build(BuildContext context) {

    final trjcentrPlace = ModalRoute.of(context).settings.arguments as String;
    final loadedTrjcenter = Provider.of<Trjcenters>(context).findbyPlace(trjcentrPlace);
