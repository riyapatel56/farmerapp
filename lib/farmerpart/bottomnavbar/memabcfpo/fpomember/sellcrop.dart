...
class SellCrop extends StatefulWidget {
  @override
  _SellCropState createState() => _SellCropState();
}

class _SellCropState extends State<SellCrop> {
  TextEditingController land = TextEditingController();
  TextEditingController money = TextEditingController();
  TextEditingController croploan = TextEditingController();
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Column(
                              ...
                              children: <Widget>[
                                new Text('Which Crop You Want To Sell',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      fontSize: 16.0,
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            new Column(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children: <Widget>[
                                new Text('Estimated Date Of Selling',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w600,
