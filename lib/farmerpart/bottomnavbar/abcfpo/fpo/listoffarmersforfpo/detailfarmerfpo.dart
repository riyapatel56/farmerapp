...
class FFPODetailPage extends StatelessWidget {
  
  static const routeName = '/farmerfpo-detail';


  @override
  Widget build(BuildContext context) {

    final ffpoPlace = ModalRoute.of(context).settings.arguments as String;
    final loadedFfpo = Provider.of<Farmerfpos>(context).findbyPlace(ffpoPlace);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blue[900],
        elevation: 0,
        title: Text(loadedFfpo.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedFfpo.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedFfpo.imgUrl),
                            ),
                          ),
                        ),
                      ),
