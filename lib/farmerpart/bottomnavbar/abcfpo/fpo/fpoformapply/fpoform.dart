...
import 'package:farmer/farmerpart/bottomnavbar/memabcfpo/fpomember/homefpom.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';



class FPOApplyForm extends StatefulWidget {
  @override
  _FPOApplyFormState createState() => _FPOApplyFormState();
}

class _FPOApplyFormState extends State<FPOApplyForm> {
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: FlatButton(
                            ...
                            color: Colors.blue[800],
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => FFPOMHome()));
                            },
                            child: Text("Apply",
