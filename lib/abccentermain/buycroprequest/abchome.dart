...
class AbBCItem extends StatelessWidget {
  ...
  const AbBCItem({Key key,this.phoneno, this.landAcre, this.id, this.name, this.trading, this.since, this.rating, this.imgUrl, this.email, this.address, this.pincode, this.state, this.income}) : super(key: key);
