...
class FmrequestDetailPage extends StatelessWidget {
  
  static const routeName = '/fmrequest-detail';


  @override
  Widget build(BuildContext context) {

    final fmrId = ModalRoute.of(context).settings.arguments as String;
    final loadedFmr = Provider.of<Fmrequests>(context).findbyId(fmrId);
    
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromRGBO(0,0,87,1),
        elevation: 0,
        title: Text(loadedFmr.name,style: GoogleFonts.openSans(),),
        actions: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 4,),
                Text(loadedFmr.rating, style: GoogleFonts.openSans(color: Colors.white),),
              ],
            ),
          )
        ],
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(loadedFmr.imgUrl),
                            ),
                          ),
                        ),
                      ),
