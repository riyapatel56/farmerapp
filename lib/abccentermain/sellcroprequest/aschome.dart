...
class ASCItem extends StatelessWidget {
  ...
  const ASCItem({Key key,this.phoneno, this.landAcre, this.id, this.name, this.growing, this.since, this.rating, this.imgUrl, this.email, this.address, this.pincode, this.state, this.income}) : super(key: key);
